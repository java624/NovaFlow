...
export default function Footer({ navItems }: FooterProps = {}) {
  ...
  return (
    <footer className="relative bg-gray-900 text-gray-300 overflow-hidden border-t border-gray-800/60">
      ...
      <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-purple-600/5 blur-[120px] pointer-events-none rounded-full" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-8 py-12 sm:py-16 lg:py-20">
          
          {/* Brand */}
          <div ref={brandRef} className="reveal-left lg:col-span-2 flex flex-col items-center text-center sm:items-start sm:text-left">
            <a href="#hero" className="flex items-center gap-3 mb-5 group">
              <div className="relative p-2 bg-gray-800/40 rounded-xl border border-gray-700/30 group-hover:border-purple-500/30 transition-colors duration-300">
                <Image
                  src="/img/logo.svg"
                  alt="NovaFlow Logo"
                  width={36}
            ...
            <div className="flex gap-4 mb-6 sm:mb-0">
              ...
              {[
                ...
                <a key={i} href="#" className="w-10 h-10 rounded-xl bg-gray-800/50 border border-gray-700/40 hover:border-purple-500 text-gray-400 hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-[0_0_15px_rgba(147,51,234,0.2)]" aria-label={soc.label}>
          ...
          <div ref={linksRef} className="reveal border-b border-gray-800/60 sm:border-0 pb-4 sm:pb-0" style={{ transitionDelay: '0.1s' }}>
          ...
          <div className="reveal border-b border-gray-800/60 sm:border-0 pb-4 sm:pb-0" style={{ transitionDelay: '0.2s' }}>
            <details className="sm:hidden group" open={false}>
              <summary className="list-none flex items-center justify-between font-bold text-white uppercase tracking-wider text-sm cursor-pointer select-none">
          ...
          {/* Newsletter */}
          <div ref={newsletterRef} className="reveal-right pt-2 sm:pt-0">
            <h4 className="text-sm font-bold text-white uppercase tracking-wider mb-4 text-center sm:text-left">
              {t('footer_col_newsletter')}
            </h4>
            <p className="text-sm text-gray-400 leading-relaxed mb-4 text-center sm:text-left">
              {t('footer_newsletter_desc')}
            </p>
            <form className="flex flex-col sm:flex-row gap-2 max-w-md mx-auto sm:mx-0" onSubmit={(e) => e.preventDefault()}>
              <input
                type="email"
                placeholder={t('newsletter_placeholder')}
                className="flex-1 px-4 py-2.5 text-sm rounded-xl bg-gray-800/60 border border-gray-700/60 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500/40 focus:border-purple-500 transition-all"
                required
              />
              <button
                type="submit"
                className="px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 rounded-xl transition-all duration-300 shadow-md hover:shadow-purple-500/20 active:scale-98"
              >
                {t('newsletter_btn')}
              </button>
            </form>
