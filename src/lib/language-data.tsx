...
export const languageConfigs: Record<string, LangConfig> = {
  english: {
    ...
    pricingPlans: [
      { id: 'test_drive', title: 'Тестовий допуск до уроку (Test Payment)', price: '$1', period: '/ 1 Test Lesson', rating: '5.0', reviews: '99+', desc: 'Тестовий платіж $1 (~40 UAH) для перевірки реальної транзакції WayForPay.', popular: false, features: ['1 Test Lesson Credit', 'Real WayForPay Checkout Verification', 'Instant Account Access'], btnText: 'Тестова оплата ($1)', btnPrice: '1', btnLessons: '1' },
